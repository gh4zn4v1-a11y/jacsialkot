        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className={`glass-strong rounded-2xl flex items-center justify-between px-4 md:px-6 py-3 transition-all ${scrolled ? "shadow-2xl" : ""}`}>
            ...
            <div className="flex items-center gap-2">
              <a
                href="tel:05223552555"
                className="hidden md:inline-flex items-center gap-2 rounded-xl glass-strong px-3 py-2.5 text-xs font-semibold text-silver hover:text-foreground transition-colors"
                title="PTCL Landline"
              >
                <Phone className="h-3.5 w-3.5 text-primary" />
                <span className="text-[10px] uppercase tracking-widest text-muted-foreground">PTCL</span>
                <span>052-3552555</span>
              </a>
              <a
          ...
          <>
            ...
            >
              ...
              <a href="tel:03217165555" className="mt-4 inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 font-semibold text-primary-foreground">
                <Phone className="h-4 w-4" /> Mobile · 0321 7165555
              </a>
              <a href="tel:05223552555" className="mt-2 inline-flex items-center justify-center gap-2 rounded-xl glass-strong px-4 py-3 font-semibold text-silver">
                <Phone className="h-4 w-4 text-primary" /> PTCL · 052-3552555
              </a>
            </motion.aside>
          </>
        )}
